    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo" style="margin-bottom:4rem">
                        <a href="index.html"><img src="{{ asset('image/logo.png') }}" width="200px"
                                alt="Logo"></a>
                    </div>
                    <h1 class="auth-title">Register</h1>
                    <p class="auth-subtitle mb-5">Register dibawah ini untuk masuk ke website ini.</p>
                    ...
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class='text-gray-600'>Sudah Mempunyai Akun?
                            @if (Route::has('login'))
                                <a href="{{ route('login') }}" class="font-bold">Login disini</a>
                            @endif
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right" style="background: #435ebe;display: flex;justify-content: center;align-items: center;">
                    <img src="{{ asset('image/regist.png') }}" alt="" width="80%" class="mb-5">
                </div>
            </div>
        </div>
