        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo mb-5">
                        <a href="index.html"><img src="{{ asset('image/logo.png') }}" width="200px" alt="Logo"></a>
                    </div>
                    <h1 class="auth-title">Login.</h1>
                    <p class="auth-subtitle mb-5">Login sesuai akun yang sudah terdaftar.</p>
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right" style="background: #435ebe;display: flex;justify-content: center;align-items: center;">
                    <img src="{{ asset('image/login.png') }}" alt="" width="80%" class="mb-5">
                </div>
            </div>
        </div>
