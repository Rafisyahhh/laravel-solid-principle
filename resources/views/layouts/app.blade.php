            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo" style="width: 10rem !important;">
                            <a href="index.html"><img src="{{ asset('image/logo.png') }}" alt="Logo"
                                    srcset=""></a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item {{ \Request::route()->getName() == 'resident.index' ? 'active' : '' }}">
                            <a href="{{ route('resident.index') }}" class='sidebar-link'>
                                <i class="bi bi-person-lines-fill"></i>
                                <span>Penduduk</span>
                            </a>
                        </li>
                        <li class="sidebar-item {{ \Request::route()->getName() == 'family.index' ? 'active' : '' }}">
                        ...
                        <li
                            class="sidebar-item {{ \Request::route()->getName() == 'address.index' ? 'active' : '' }}">
                        ...
                        <li
                            class="sidebar-item {{ \Request::route()->getName() == 'status.index' ? 'active' : '' }}">
                        ...
                        <li
                            class="sidebar-item {{ \Request::route()->getName() == 'education.index' ? 'active' : '' }}">
                            <a href="{{ route('education.index') }}" class='sidebar-link'>
                                <i class="bi bi-mortarboard-fill"></i>
                                <span>Pendidikan</span>
                            </a>
                        </li>
                        <li class="sidebar-item {{ \Request::route()->getName() == 'work.index' ? 'active' : '' }}">
